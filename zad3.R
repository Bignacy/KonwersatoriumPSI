...
text <- readLines("E:/onedrivedwa/OneDrive/z one drive/Pulpit/4_SEMESTR/PSI/zajecia2/Biden - First address to Congress_2021.txt")
text <- readLines("E:/onedrivedwa/OneDrive/z one drive/Pulpit/4_SEMESTR/PSI/zajecia2/Biden - State of the Union 2024.txt")
text
...
# ODPOWIEDZ: Priorytety sa rozne: 2021 wskazuje na dzialanie i na prace ludzi, zas kluczowe slowa w 2024 to furue i president
# co jest bardziej skierowane na wyniki wyborow niz na rzeczywiste dzialania
